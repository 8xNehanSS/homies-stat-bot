module.exports = {
    ...
    aliases: ["leaderspoints","plb"],
    public: true,
    async execute(bot, message, args, config) {
    User.find({ guildID: message.guild.id }).sort([['money','descending']]).exec((err,res) => {
        let embed = new Discord.MessageEmbed().setTitle("**Points Leaderboard**").setColor(config.color).setThumbnail("https://cdn.discordapp.com/attachments/861614593444937739/927832635613536276/Untitled1.jpg").setFooter("Points in your hand").setTimestamp()
